...
/**
 * 유기견 등록 요청 DTO
 * 클라이언트로부터 유기견 정보를 받기 위한 데이터 전송 객체
 */
@Getter
@NoArgsConstructor
@Schema(description = "유기견 등록 요청 데이터")
public class DogCreateRequestDto {
    ...
    @Schema(description = "입양상태 (입양_가능/입양_절차_중/입양_완료)", example = "입양_가능", defaultValue = "입양_가능")
    private AdoptionStatus adoptionStatus = AdoptionStatus.입양_가능;
    ...
    @Schema(description = "보호소 ID (선택)", example = "1")
